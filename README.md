...
How to Use
1. 
Enter your text in the top text box
2. 
Select your target language from the dropdown menu
3. 
Click Translate or press Ctrl+T
4. 
View the translated text in the bottom box
Translate a File:
1. 
Click From File... or press Ctrl+F
2. 
Select a .txt file
3. 
The content will load automatically
4. 
Click Translate or press Ctrl+T
Other Features:
• 
